...
namespace MetricsAPI.Application.Core.Helpers.Metric;
...
public sealed class CreateMetricsHelper
{
    private static readonly Counter RequestCounter =
        Metrics.CreateCounter("MetricsAPI_requests_total", "Total number of requests.");
    ...
    public async Task CreateMetrics(Stopwatch stopwatch)
    {
        ...
        Metrics.CreateHistogram("MetricsAPI_request_duration_seconds", "Request duration in seconds.")
