namespace MetricsAPI.Domain.Common.Core.Primitives.Result;
...
public static class ResultExtensions
{
    ...
    public static async Task<Result> Bind<TIn>(this Result<TIn> result, Func<TIn, Task<Result>> func) =>
        result.IsSuccess ? await func(result.Value) : Common.Core.Primitives.Result.Result.Failure(result.Error).Result;
